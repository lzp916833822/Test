...
import com.comm.weights.action.KeyBoardActionListence;
import com.comm.weights.action.OnEditFocusChangeListence;
import com.comm.weights.impl.FormatTextWatcher;
import com.comm.weights.impl.SystemOnKeyboardActionListener;
import com.face.R;
...
public class SystemKeyBoardEditText extends KeyBoardEditText {
    ...
    public void showKeyboardWindow(){
        super.showKeyboardWindow();
    }

    public void dismissKeyboardWindow(){
        super.dismissKeyboardWindow();
    }
