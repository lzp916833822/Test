...
public abstract class AbstractUVCCameraHandler extends Handler {
    ...
    public interface CameraCallback {
        ...
        public abstract void onError(final Exception e);
    }
...
//		}
        ...
        public void handleStartPreview(final Object surface) {
            if (DEBUG) Log.v(TAG_THREAD, "handleStartPreview:" + mUVCCamera + " ---:" + mIsPreviewing);
...
//				}
        ...
        private void saveYuv2Jpeg(String path, byte[] data) {
            ...
            if (result) {
                ...
                files.mkdir();
                File file = new File(path+getTimeBySystem("yyyy.MM.dd-HH:mm:ss")+".png");
                ...
                if (mCaptureListener != null) {
                    mCaptureListener.onCaptureResult(file.getPath());
                }
            }
            try {
                bos.close();
        ...
        private String getTimeBySystem(String dateFormat){
...
//				}
        ...
        public void callOnFrame(ByteBuffer frame){
            for (final CameraCallback callback: mCallbacks) {
                try {
